...
I (re-)moved docs, recipes, authors and index cards to the `unused` folder in order for them to not be there and show `404` error. Just move them back to their respective places.
